...
<?php
    ...
    if(isset($_POST["name"]) && isset($_POST["image"]) && isset($_POST["address"]) && isset($_POST["workingtime"]) && isset($_POST["pricerange"]) 
      && isset($_POST["phonenumber"]) && isset($_POST["foodtypes"])){
            ...
            $sql_1 = "insert into food (postID, address, image, foodName, phoneNumber, priceRange, workingTime)
            ...
            values ((select max(postID) from post), '$foodtypes')";
...
<div class="formcontainer">
  <form method = "post" action="addingFood.php" onSubmit = "return checkNull()">
  <div class="row">
    <div class="col-25">
